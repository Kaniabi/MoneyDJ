...
class QuickTransactionForm(forms.Form):
    ...
    amount = forms.DecimalField(label=_(u'Amount'), decimal_places=2, max_digits=8, help_text=_('The amount of the transaction as a decimal amount (e.g. 13.24). Don\'t worry about putting the sign or thousand separators - we\'ll handle them.'))
