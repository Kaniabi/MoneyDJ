"""
From http://www.djangosnippets.org/snippets/766/
"""
import time
...
class DebugFooter:
    ...
    def _storeRenderedTemplates(self, **kwargs):
        self.templates_used.append(kwargs.get('template', 'unknown'))
        self.contexts_used.append(kwargs.get('context', 'unknown'))
